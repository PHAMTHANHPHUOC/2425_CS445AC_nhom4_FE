                            ...
                            <div class="card-body">
                                <div class="p-5">
                                    <div class="text-center">
                                        <img
                                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfEU2rXvs5sNGYzb9RYhxYVXnc8G3xX9fBbw&s"
                                            width="180"
                                            alt=""
                                        />
                                    </div>
                                    ...
                                    <div class="d-grid gap-2">
                                        <button v-on:click="LayLaiMatKhau()" type="button" class="btn btn-primary">
                                            Thay đổi mật khẩu
                                        </button>
                                    </div>
                                </div>
