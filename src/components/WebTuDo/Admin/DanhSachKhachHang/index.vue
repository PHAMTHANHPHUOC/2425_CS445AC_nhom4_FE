                ...
                <tr class="align-middle">
                  ...
                  <td class="text-center">
                    ...
                    >
                      <a
                        class="dropdown-item"
                        v-on:click="Object.assign(edit_khach_hang, value)"
                        data-bs-toggle="modal"
                        data-bs-target="#capNhatKhachhangModal"
                        >Cập Nhật Khách hàng</a
                      >
                      <a
                        class="dropdown-item"
                        v-on:click="Object.assign(edit_khach_hang, value)"
                        data-bs-toggle="modal"
                        data-bs-target="#doiMatKhauKhachHangModal"
                        >Cập Nhật Mật Khẩu</a
                      >
                    </div>
                    <button
                      class="btn btn-danger"
                      v-on:click="Object.assign(delete_khach_hang, value)"
                      data-bs-toggle="modal"
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="col-md-12 mb-2">
            ...
            <input
              v-model="edit_khach_hang.ho_va_ten"
              type="text"
              class="form-control"
            />
          </div>
        ...
        <div class="modal-footer">
          ...
          <button
            ...
            data-bs-dismiss="modal"
            v-on:click="actionCapNhatTaiKhoan()"
          >
            Xác Nhận
          </button>
        </div>
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="ms-3">
                ...
                <div class="text-white">
                  ...
                  <b>{{ delete_khach_hang.ho_va_ten }}</b> này không!
                </div>
              </div>
            </div>
            <button
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button
            ...
            class="btn btn-primary"
            data-bs-dismiss="modal"
            v-on:click="actionDoiMatKhauTaiKhoan()"
          >
            Xác Nhận
          </button>
        </div>
...
export default {
  ...
  methods: {
    ...
    actionDoiTrangThaiTaiKhoan(value) {
      baseRequest.post("admin/khach-hang/doi-trang-thai", value).then((res) => {
        if (res.data.status) {
          toaster.success(res.data.message);
          this.loadDataKhachHang();
        } else {
    ...
    actionDoiMatKhauTaiKhoan() {
      ...
      baseRequest.post("admin/doi-mat-khau", payload).then((res) => {
        if (res.data.status) {
          toaster.success(res.data.message);
          this.new_password = "";
          this.re_password = "";
